{{ site.data[page.slug].title }} integrates with __*carefully-researched, best-in class plugins*__ to provide you with all the functionality you need to build great restaurant websites.
